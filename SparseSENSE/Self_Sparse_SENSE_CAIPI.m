function [Inew,senseMap]=Self_Sparse_SENSE_CAIPI(CompI,ParK,SSM,g_map,Phi,Par,flag_CAIPI)
%INPUTS
...
%          tic;
         [Inew,RecMtx]=PriRegSENSEtmp_CAIPI(ParK,nI,senseMap,SSM,Phi,Par,flag_CAIPI);
%          toc
